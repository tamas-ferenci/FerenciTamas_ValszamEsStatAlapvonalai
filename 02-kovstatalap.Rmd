...
knitr::include_app( "https://tamas-ferenci.shinyapps.io/likelihood/", height = "600px" )
```
...
```{r, screenshot.opts = list(delay = 5)}
knitr::include_app( "https://tamas-ferenci.shinyapps.io/bayesbecsles/", height = "800px" )
```
...
```{r, screenshot.opts = list(delay = 5)}
knitr::include_app( "https://tamas-ferenci.shinyapps.io/deduktiv/", height = "600px" )
```
