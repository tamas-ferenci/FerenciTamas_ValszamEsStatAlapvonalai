...
knitr::include_app( "http://research.physcon.uni-obuda.hu/Likelihood/", height = "400px" )
```
...
```{r, screenshot.opts = list(delay = 5)}
knitr::include_app( "http://research.physcon.uni-obuda.hu/BayesBecsles/", height = "400px" )
```
...
```{r, screenshot.opts = list(delay = 5)}
knitr::include_app( "http://research.physcon.uni-obuda.hu/Deduktiv/", height = "400px" )
```
