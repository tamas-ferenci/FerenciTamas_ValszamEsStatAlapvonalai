...
knitr::include_app( "https://193.224.41.36/shiny/Likelihood/", height = "600px" )
```
...
```{r, screenshot.opts = list(delay = 5)}
knitr::include_app( "https://193.224.41.36/shiny/BayesBecsles/", height = "800px" )
```
...
```{r, screenshot.opts = list(delay = 5)}
knitr::include_app( "https://193.224.41.36/shiny/Deduktiv/", height = "600px" )
```
